...
Verwaltung von Softwareprojekten basiert, werden im Folgenden einige dieser Schlüsselaspekte aufgezeigt:
...
\begin{itemize}
    ...
    \item {
        ...
        ständig über den Status des Projektes informiert sind.
