...
\footpartcite{docker}
Container bieten somit ein hohes Maß an Reproduzierbarkeit und Konsistenz über verschiedene Umgebungen hinweg.
Damit Tests und Analyse-Tools sowohl in einer Pipeline, als auch bei der Entwicklung ausgeführt werden können, wird in
der Strategie eine Konfiguration für das lokale Ausführen der Shopware-Instanz in Docker-Images hinterlegt.
\acrshort{ci}-Tools sollten in der Regel lokal Ausführbar sein um nicht in
