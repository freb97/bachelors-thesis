...
Hierfür wurde eine Konfigurationsdatei im YAML-Format angelegt, welches häufig zur Konfiguration von Programm-Daten
genutzt wird:

\yamlfile{code/docker-compose.yml}

Die aufgezeigte Konfigurationsdatei definiert zwei Container:\ \glqq shop\grqq\ und\ \glqq database\grqq.
Diese sind über ein angegebenes Netzwerk\ \glqq web\grqq\ miteinander verbunden und haben jeweils offene Ports zur
Kommunikation hinterlegt.
Außerdem wurde ein Docker-Volume für das Persistieren der lokalen Datenbank angelegt, welches sich um dessen
Datenverwaltung kümmert.
...
Darüber hinaus wurde für die Datenbank eine Konfigurationsdatei für Umgebungsvariablen angegeben, in der
die Zugangsdaten für Datenbank-Nutzer hinterlegt werden können.
\\\\
...
\begin{itemize}
    ...
    \item {
        ...
        Diese Jobs folgen dabei dem selben Prinzip und nutzen das Tool \shellinline{Deployer}, welches das Ausliefern
