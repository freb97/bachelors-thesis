...
Durch die gezielte Implementierung von\ \acrshort{ci}-Praktiken in solchen Projekten kann der Entwicklungszyklus effizienter
...
Die nachfolgend definierten \hyperref[item:01-introduction-2-goals]{Ziele} $Z_n$ dienen als Leitfaden für die Konzeption und Entwicklung der\
...
\begin{itemize} \label{item:01-introduction-2-goals}
    \item {
...
\acrlong{ci}, sowie eine Übersicht über die Shopware-Plattform.
