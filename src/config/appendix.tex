...
\begin{figure}[H]
    ...
    \captioncite[\hyperlink{cite.gitlab}{GitLab B.V.}]{}{Darstellung ausgeführter Pipelines durch GitLab CI/CD}
...
\begin{figure}[H]
    ...
    \captioncite[\hyperlink{cite.gitlab}{GitLab B.V.}]{}{Status-Anzeige von Jobs}
...
\begin{figure}[H]
    ...
    \captioncite[\hyperlink{cite.gitlab}{GitLab B.V.}]{}{Überblick der Jobs einer Pipeline}
